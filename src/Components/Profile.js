...
function Profile(props) {
    return (
        <div className='container d-flex flex-column align-items-center' style={{ fontSize: '20px', marginTop: '10%', width: "30%", padding: "3%", borderRadius: "10px", backgroundColor: "#96b8fb" }}>
