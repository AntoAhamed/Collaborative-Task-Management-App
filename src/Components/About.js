      ...
      <div className='row'>
        <div className='col-7 d-flex flex-column justify-content-center' style={{ padding: '0 6%' }}>
          ...
          <div>
            ...
            <p>
              At <strong>CTMA</strong>, we understand that task management is very important in our professional life. Whether you're a student, a professional, or just someone who likes to keep things organized, having a reliable and user-friendly task management app can make all the difference.
            ...
            <p>
              <strong>Thank you</strong> for choosing <strong>CTMA</strong> as your go-to task management app. We're excited to be a part of your journey towards greater productivity and organization.
            </p>
          </div>
        </div>
